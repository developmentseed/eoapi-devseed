...
PROFILES = [
    TrafficProfile(
        "idle", 8, (1, 2), (3 * 60, 8 * 60), (3.0, 8.0), (10.0, 25.0), (60, 5 * 60)
    ),
    TrafficProfile(
        "easy", 35, (2, 5), (5 * 60, 15 * 60), (1.0, 4.0), (4.0, 12.0), (20, 2 * 60)
    ),
    TrafficProfile(
        "normal", 35, (5, 10), (5 * 60, 20 * 60), (0.4, 1.5), (2.5, 6.0), (10, 90)
    ),
    TrafficProfile(
        "heavy", 17, (10, 18), (3 * 60, 10 * 60), (0.1, 0.5), (0.8, 2.5), (10, 60)
    ),
    TrafficProfile(
        "burst", 5, (18, 30), (60, 3 * 60), (0.0, 0.2), (0.3, 1.2), (30, 3 * 60)
    ),
]
...
def choose_profile() -> TrafficProfile:
    return random.choices(
        PROFILES, weights=[profile.weight for profile in PROFILES], k=1
    )[0]
